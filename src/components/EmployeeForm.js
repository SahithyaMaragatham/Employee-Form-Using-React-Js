...
const Employeeform = () => {
    ...
    const [submissionMessage, setSubmissionMessage] = useState(''); // State for success message
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            ...
            setSubmissionMessage('The form was submitted successfully!'); // Set success message
                ...
                <div className="row g-3">
                    ...
                    <div className="col-md-4">
                        ...
                        {errors.billableHours && (
                            <div className="invalid-feedback">{errors.billableHours}</div>
                        )}
                    </div>
                    <div className="col-md-4">
